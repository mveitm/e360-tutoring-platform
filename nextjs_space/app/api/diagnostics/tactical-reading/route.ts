 ...
 *
 * Pure read endpoint. No side effects. No interpretation of answer content.
 * Delivers the minimal tactical verdict for continuity-start logic.
 *
 * Semantic reminder (see lib/diagnostics/tactical-reading.ts):
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const result = await readTacticalVerdict(prisma, {
      enrollmentId,
      diagnosticType,
    })
