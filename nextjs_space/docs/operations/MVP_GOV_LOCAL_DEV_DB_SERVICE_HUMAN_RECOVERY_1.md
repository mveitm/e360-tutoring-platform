...
Guide, verify and document the human/local recovery needed for the LOCAL_DEV DB service so the safe DB tooling can execute a read-only `Program` table query.
...
```text
HEAD = origin/main = origin/HEAD = 8e0cebbb96c20d0739408629310938a055c89785
```
...
```text
working tree: clean
HEAD: 8e0cebbb96c20d0739408629310938a055c89785
origin/main: 8e0cebbb96c20d0739408629310938a055c89785
origin/HEAD: 8e0cebbb96c20d0739408629310938a055c89785
```
...
Sanitized checklist state observed by tooling:
